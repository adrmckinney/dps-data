...
export const RACE: SubGroupList[] = [
    ...
    },
    {
        ...
        key: 'I',
        secondaryKey: 'American Indian - Total',
        typeId: subGroupTypes.race.value,
    ...
    },
    {
        ...
        key: 'HP',
        secondaryKey: 'Hawaiian Pacific - Total',
        typeId: subGroupTypes.race.value,
        dataSets: ['POPULATION_SUBGROUP'],
        collisions: [
    ...
    },
    {
        ...
        key: 'MR',
        secondaryKey: 'Multi Racial - Total',
        typeId: subGroupTypes.race.value,
        dataSets: ['POPULATION_SUBGROUP'],
        collisions: [
