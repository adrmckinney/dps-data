...
def to_pyarrow_type(
    dtype: ArrowDtype | pa.DataSet | Dtype | None,
) -> pa.DataSet | None:
    """
    ...
    elif isinstance(dtype, pa.DataSet):
        return dtype
...
class ArrowExtensionArray(
    ...
    @classmethod
    def _box_pa(
        cls, value, pa_type: pa.DataSet | None = None
    ...
    @classmethod
    def _box_pa_scalar(cls, value, pa_type: pa.DataSet | None = None) -> pa.Scalar:
        """
    ...
    @classmethod
    def _box_pa_array(
        cls, value, pa_type: pa.DataSet | None = None, copy: bool = False
    ...
    def _if_else(
        ...
        def _to_numpy_and_type(value) -> tuple[np.ndarray, pa.DataSet | None]:
